...
proc create_root_design { parentCell } {
  ...
  # Create instance: Read_writedata_1, and set properties
  set block_name Read_writedata
  set block_cell_name Read_writedata_1
  if { [catch {set Read_writedata_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Read_writedata_1 eq "" } {
  ...
  connect_bd_net -net Read_writedata_1_RPM_vector [get_bd_pins Read_writedata_1/RPM_vector] [get_bd_pins axi_gpio_0/gpio2_io_i]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Read_writedata_1/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins Read_writedata_1/hall_a] [get_bd_pins xlslice_0/Dout]
